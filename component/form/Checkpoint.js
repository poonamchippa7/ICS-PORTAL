                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Living_Condition1"
                                                onChange={inputEvent}
                                                value={fname.Living_Condition1}
                                            >
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Animals_fed_with_organic_or_non_organic_feed1"
                                                onChange={inputEvent}
                                                value={fname.Animals_fed_with_organic_or_non_organic_feed1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="No_medication_without_veterinary_prescription1"
                                                onChange={inputEvent}
                                                value={fname.No_medication_without_veterinary_prescription1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Whole_farm_is_managed_organically1"
                                                onChange={inputEvent}
                                                value={fname.Whole_farm_is_managed_organically1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="conventional_plots_clearly_separate_from_organic_plots1"
                                                onChange={inputEvent}
                                                value={fname.conventional_plots_clearly_separate_from_organic_plots1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="organic_crop_is_not_grown_on_non_organic_plots1"
                                                onChange={inputEvent}
                                                value={fname.organic_crop_is_not_grown_on_non_organic_plots1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Seeds_and_planting_material_used1"
                                                onChange={inputEvent}
                                                value={fname.Seeds_and_planting_material_used1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Farmer_trained_in_organic_standards1"
                                                onChange={inputEvent}
                                                value={fname.Farmer_trained_in_organic_standards1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Farmer_aware_of_internal_organic_standard1"
                                                onChange={inputEvent}
                                                value={fname.Farmer_aware_of_internal_organic_standard1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="General_assessment_of_the_farm_with_regard_to_sustainability1"
                                                onChange={inputEvent}
                                                value={fname.General_assessment_of_the_farm_with_regard_to_sustainability1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Burning_of_crop_residues1"
                                                onChange={inputEvent}
                                                value={fname.Burning_of_crop_residues1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Border_and_prevention_of_drift1"
                                                onChange={inputEvent}
                                                value={fname.Border_and_prevention_of_drift1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Pest_Management1"
                                                onChange={inputEvent}
                                                value={fname.Pest_Management1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Disease_Management1"
                                                onChange={inputEvent}
                                                value={fname.Disease_Management1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Prevention_of_erosion1"
                                                onChange={inputEvent}
                                                value={fname.Prevention_of_erosion1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Cleanliness_of_the_farm1"
                                                onChange={inputEvent}
                                                value={fname.Cleanliness_of_the_farm1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Implementation_of_all_required_activities1"
                                                onChange={inputEvent}
                                                value={fname.Implementation_of_all_required_activities1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="General_assessment_of_crop1"
                                                onChange={inputEvent}
                                                value={fname.General_assessment_of_crop1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
                                    ...
                                    <tr ng-repeat="name in getdrugnameNewArray">
                                        ...
                                        <Form.Group as={Row} className="mb-3">
                                            ...
                                            <Col sm={5}>
                                            <Form.Select
                                                name="Yield_estimate1"
                                                onChange={inputEvent}
                                                value={fname.Yield_estimate1}
                                            >
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                                <option value="NA">NA</option>
